...
infileDRC_up = drcDir+'upper_HORI.dat'
infileDRC_low = drcDir+'lower_HORI.dat'
infileFLC = './flc_w_drc_trans814.dat'
...
# x_drc_up = drc_up['x_i']
# y_drc_up = drc_up['y_i']
# xm_flc_up = flc_all['xdrc_up_f814w']
# ym_flc_up = flc_all['ydrc_up_f814w']
...
xm_flc_low = flc_all['xdrc_low_f814w']
ym_flc_low = flc_all['ydrc_low_f814w']
...
# print(len(idxs1))
# print(len(idxs2))
# print('Max IDXS2:',np.max(idxs2))
# print('Max IDXS1:',np.max(idxs1))

# print(len(xm_flc_up))
# print(len(x_drc_up))

outfile = outDir+'hor-I-cut_drc_low_814_tol5.txt'
np.savetxt(outfile, idxs2, fmt='%4i')

outfile = outDir+'hor-I-cut_flc_low_814_tol5.txt'
...
outfile = outDir+'hor-I-cut_ds_low_814_tol5.txt'
