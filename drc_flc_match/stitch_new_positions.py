...
new_up = np.genfromtxt(trans_Dir+'upper_hor1_814_xy.dat')
new_low = np.genfromtxt(trans_Dir+'lower_hor1_814_xy.dat')

# flc file to tack onto
# flc_old = np.genfromtxt(split_Dir+'HORI_pix_2212_d6_dist.dat')
flc_606 = np.genfromtxt(trans_Dir+'flc_w_drc_trans.dat')


concat1 = np.hstack((flc_606, new_up))
...
np.savetxt(trans_Dir+'flc_w_drc_trans814.dat',concat2,fmt="%1.5f",header=header)
