...
def run_sph(outpre,tol=1e-2):

    infile1 = outpre+'_drc_magCuts.dat'
    infile2 = outpre+'_flc_magCuts.dat'
    ...
    outfile1 = idxDir+outpre+'_drc_match_'+str(tol)+'_magCuts.dat'
    np.savetxt(outfile1, idx1, fmt='%4i')
    outfile2 = idxDir+outpre+'_flc_match_'+str(tol)+'_magCuts.dat'
