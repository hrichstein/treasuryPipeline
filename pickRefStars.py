...
inDir = '/Volumes/Spare Data/Hannah_Data/hor1dir3103/'
...
data = np.genfromtxt(inDir+name+'-cut-std_pix_matched_'+filter+'_nC.dat',names=True)
...
#
np.savetxt(inDir+name+'_refStars_'+filter+'_nC.dat', data[keep], fmt='%1.5f', header=header)
