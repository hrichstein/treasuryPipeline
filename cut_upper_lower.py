...
np.savetxt(save_dir+'upper_drc.dat',upper_drc,header=header_drc)
np.savetxt(save_dir+'lower_drc.dat',lower_drc,header=header_drc)
...
np.savetxt(save_dir+'upper_flc.dat',upper_flc,header=header_flc)
np.savetxt(save_dir+'lower_flc.dat',lower_flc,header=header_flc)
