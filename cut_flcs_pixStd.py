...
def filterMags(targname,filter,stdCut=2.5):
    ...
    header = 'RA DEC flux c_star xr_1 yr_1 xt_1 yt_1 mag1 xr_2 yr_2 xt_2 yt_2 mag2 xr_3 yr_3 xt_3 yt_3 mag3 xr_4 yr_4 xt_4 yt_4 mag4 mean stdev pos_std cut_flag idx_cut num_abv_std'
