...
catDir = "catRawMags2212/catDir/"
coordDir = 'mags2212/coordDir/'
posDir = '/Volumes/Spare Data/Hannah_Data/positions/'
# magDir = 'mags0811/'
out_dir = '/Volumes/Spare Data/Hannah_Data/hor1dir2212/'
...
def pullRawPos(targname,filter):
    ...
    for jj in range(len(jdanUse)):
        cat = np.loadtxt(posDir+ jdanUse[jj] +"_"+targname+'_'+ filter +"_dc_new2_t2.dat",comments='#')
